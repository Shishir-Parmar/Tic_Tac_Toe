...
{
  return document.getElementById("col" + number).textContent;
}
...
{
    document.getElementById("col" + number).textContent = "";
}
...
/*const restart=document.getElementById('resets');
